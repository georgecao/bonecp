...
public class TestConnectionMaxAgeTester {
    ...
    public void testConnectionExpired() throws Exception {

        TransferQueue<ObjectHandle> mockQueue = createNiceMock(TransferQueue.class);
        expect(mockConnectionPartition.getAvailableObjects()).andReturn(1);
    ...
    public void testConnectionNotExpiredLifoMode() throws Exception {
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void testConnectionNotExpired() throws Exception {
    ...
    @Test
    @SuppressWarnings({"unchecked"})
    public void testExceptionsCase() throws Exception {

        TransferQueue<ObjectHandle> mockQueue = createNiceMock(TransferQueue.class);
        expect(mockConnectionPartition.getAvailableObjects()).andReturn(2);
        expect(mockConnectionPartition.getFreeObjects()).andReturn(mockQueue).anyTimes();
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void testExceptionsCaseWherePutInPartitionFails() throws Exception {
     ...
     */
    @Test
    public void testCloseConnectionNormalCase() throws Exception {
        ObjectHandle mockConnection = createNiceMock(ObjectHandle.class);

...
public class TestBoundedLinkedTransferQueue {
     ...
     */
    static BoundedLinkedTransferQueue<Object> testClass = new BoundedLinkedTransferQueue<>(50);
     ...
     */
    @Test(dependsOnMethods = {"testRemainingCapacity"})
     ...
     * Tests offer.
     */
    @Test(dependsOnMethods = {"testTryTransfer"})
     ...
     * Tests poll.
     */
    @Test(dependsOnMethods = {"testPollLongTimeUnit"})
     ...
     * Tests put.
     */
    @Test(dependsOnMethods = {"testPoll"})
    public void put() {
        try {

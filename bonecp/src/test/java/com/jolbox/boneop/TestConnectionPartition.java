...
public class TestConnectionPartition {
	...
	public void testFinalizer() throws SQLException, InterruptedException{
		...
		expect(mockConnectionHandle.getInternalObject()).andReturn(connection).anyTimes();
	...
	class MemorizeTransactionProxyDummy  extends MemorizeTransactionProxy {
		 ...
		 * @return proxy
		 */
		protected Connection memorizeDummy(final Connection target, final ObjectHandle connectionHandle) {
